...
import com.example.kbtu_helper.presenter.adapter.ChatAdapter
import com.example.kbtu_helper.model.chats.Chat
import com.example.kbtu_helper.model.chats.ChatViewModel
...
//        setSupportActionBar(toolbar)
        ...
        try {
            Picasso.get().load(externalImage).placeholder(R.drawable.ic_default_avatar)
                .into(profile)
        } catch (e: Exception) {
