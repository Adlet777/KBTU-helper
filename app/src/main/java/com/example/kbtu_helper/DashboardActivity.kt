            ...
            when (it.itemId) {
                ...
                R.id.nav_profile -> {
                    ...
                    val profileFragment = ProfileFragment()
                        supportFragmentManager.beginTransaction().replace(R.id.content, profileFragment, "")
                            .commit()
                    return@setOnItemSelectedListener true
                }
                R.id.nav_users -> {
                    ...
                    val usersFragment = UsersFragment()
                        supportFragmentManager.beginTransaction().replace(R.id.content, usersFragment, "")
                            .commit()
                    return@setOnItemSelectedListener true
                }
                R.id.nav_subjects -> {
                    ...
                    supportFragmentManager.beginTransaction().replace(R.id.content, subjectsFragment, "")
                        .commit()
                    return@setOnItemSelectedListener true
                }
                R.id.nav_chat -> {
